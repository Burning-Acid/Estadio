...
public class Ventana extends javax.swing.JFrame {
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(jLabel14, javax.swing.GroupLayout.PREFERRED_SIZE, 573, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void jButton9ActionPerformed(java.awt.event.ActionEvent evt) {                                         
            ...
            if((String)jComboBox4.getSelectedItem()=="Cuartos de Final" && bandera){
                ...
                for(int i=0;i<32;i++){
                    ...
                    EquipoPais equipo = equipos.get(i);
                    grupo=equipo.getCodGrupo().getNomGrupo();
                    numero=0;
                    nombre=equipo.getNombre();
                    partidosGanados=calcularPartidosGanados(equipo);
                    partidosPerdidos=calcularPartidosPerdidos(equipo);
                    partidosEmpatados=calcularPartidosEmpatados(equipo);
                    int puntos = partidosGanados*3+partidosEmpatados;
                    table.addRow(new Object[]{grupo, numero,nombre ,partidosGanados,partidosEmpatados,partidosPerdidos,puntos});
    ...
    private void ordenarTablaPartidos(){
        ...
        int numeroAux;
        String nombreAux;
        int partidosGanadosAux;
        int partidosPerdidosAux;
        int partidosEmpatadosAux;
        int auxPuntos;
        for(int i=0;i<table.getRowCount();i++){
            for(int j=0;j<table.getRowCount()-1;j++){
                int diferencia;
                holiAux=(String)table.getValueAt(j, 0);
                diferencia = holiAux.compareTo((String)table.getValueAt(j+1, 0));
                if(diferencia==0){
                    if((int)table.getValueAt(j, 6)<(int)table.getValueAt(j+1, 6)){
                        numeroAux=(int)table.getValueAt(j, 1);
                        nombreAux=(String)table.getValueAt(j, 2);
                        partidosGanadosAux=(int)table.getValueAt(j, 3);
                        partidosEmpatadosAux=(int)table.getValueAt(j, 4);
                        partidosPerdidosAux=(int)table.getValueAt(j, 5);
                        auxPuntos=(int)table.getValueAt(j, 6);
                        table.setValueAt((String)table.getValueAt(j+1, 0), j, 0);
                        table.setValueAt((int)table.getValueAt(j+1, 1), j, 1);
                        table.setValueAt((String)table.getValueAt(j+1, 2), j, 2);
                        table.setValueAt((int)table.getValueAt(j+1, 3), j, 3);
                        table.setValueAt((int)table.getValueAt(j+1, 4), j, 4);
                        table.setValueAt((int)table.getValueAt(j+1, 5), j, 5);
                        table.setValueAt((int)table.getValueAt(j+1, 6), j, 6);
                        table.setValueAt(holiAux, j+1, 0);
                        table.setValueAt(numeroAux, j+1, 1);
                        table.setValueAt(nombreAux, j+1, 2);
                        table.setValueAt(partidosGanadosAux, j+1, 3);
                        table.setValueAt(partidosEmpatadosAux, j+1, 4);
                        table.setValueAt(partidosPerdidosAux, j+1, 5);
                        table.setValueAt(auxPuntos, j+1, 6);
                    }    
                }
            }
        }
    ...
    private void jButton10ActionPerformed(java.awt.event.ActionEvent evt) {                                          
        ...
        if(table.getRowCount()!=0){
            ...
            for(Partido p:partidos){
                 StringTokenizer st = new StringTokenizer(p.getFecha().toString());
                 st.nextToken();
                 fecha=st.nextToken();
                ...
                if(p.getNumPartido()>48 && p.getNumPartido()<57){
                    int numPartido=p.getNumPartido();
                    String nomEstadio=p.getCodEstadio().getNombre();
                    String nomCiudad = p.getCodEstadio().getCiudad();
                    equipos=p.getCodEquipoLocal().getNombre()+"-"+p.getCodEquipoVisitante().getNombre();
                    table1.addRow(new Object[]{numPartido, fecha,nomEstadio ,nomCiudad,equipos,hora});
                }
